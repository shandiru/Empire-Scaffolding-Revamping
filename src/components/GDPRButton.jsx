      ...
      {visible && (
        <div className="fixed bottom-4 left-4 right-4 md:bottom-6 text-center md:right-6 md:left-auto max-w-full md:max-w-xs p-4 rounded-lg 
          ...
          <p className="mb-3">
            <a
              href="/privacy-policy"
              className="underline text-blue-600 hover:text-blue-800 dark:text-blue-600 dark:hover:text-blue-800"
            >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3">
            <button
              ...
              className="bg-blue-600 text-white px-4 py-2 rounded text-sm hover:bg-blue-800 dark:hover:bg-blue-800 transition"
            >
              Reject
            </button>
            <button
