...
const GALLERY_ITEMS = [
  { id: 1, image: 'https://images.unsplash.com/photo-1516627145497-ae6968895b74?w=600', alt: 'Girl with balloon' },
  { id: 2, image: 'https://images.unsplash.com/photo-1585110396000-c9ffd4e4b308?w=600', alt: 'Rabbit' },
  { id: 3, image: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600', alt: 'Hot air balloon' },
  { id: 4, image: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600', alt: 'Child with tomatoes' },
  { id: 5, image: 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=600', alt: 'Corgi puppy' },
  { id: 6, image: 'https://images.unsplash.com/photo-1517783999520-f068d7431a60?w=600', alt: 'Penguins' },
];
...
export default function GalleryCarousel() {
  ...
  return (
    ...
    >
          ...
          {GALLERY_ITEMS.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Progressive shadows to blend receding elements into the background */}
                <div
                  className="absolute inset-0 bg-[#0d0e11] pointer-events-none transition-opacity duration-300"
                ...
                {/* Information Node Icon */}
                {cfg.visible && (
                  <div
                    className="absolute z-10 flex items-center justify-center rounded-full border border-white/10 text-white/70 backdrop-blur-md bg-black/30"
                    style={{
      ...
      <p className="mt-4 text-white/[0.12] text-[9px] tracking-[0.38em] uppercase">
        Swipe or use arrows
      </p>
    </div>
  );
