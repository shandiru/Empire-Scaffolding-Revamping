    ...
    return (
        <div className="bg-black text-white">
            <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-16">
                <h1 className="text-4xl font-semibold text-center mb-8 mt-15 text-white">Privacy Policy</h1>
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">2. Lawful Basis for Processing</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">3. How We Use Your Information</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">4. Sharing Your Information</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">5. Cookies & Website Tracking</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">6. Data Security</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">7. How Long We Keep Your Information</h2>
                    <p className="text-gray-300">
                ...
                <section>
                    <h2 className="text-2xl font-medium text-white">8. Your Rights</h2>
                    <p className="text-gray-300">
